...
% When projecting on two screens, I use Dual Screen PDF Viewer: 
% https://dspdfviewer.danny-edel.de/
% It's open source and it works perfectly on all operating systems
...
\begin{frame}
    ...
    % Font size
    % arbitrary size: \fontsize{<size>}{<size>}\selectfont <Mytext>
    % make text smaller: \smaller[x] where x is an integer
    % compensate interline in lists: \setlength\itemsep{0.05cm}
    % \begin{enumerate}
