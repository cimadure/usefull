...
%\usetheme{default} % sans froufrou
%\usetheme{CambridgeUS} % one liner and red
\usetheme{Boadilla} % softter
%\usetheme{Madrid} % Classic and standard
%\usetheme{Singapore} % dot vertical and horizontal on top

%\usetheme{Luebeck} % fonctionne mieux avec 2 etage en haut
%\usetheme{Berkeley} % can follow where we are plus color bubble

%\usetheme{Antibes}
%\usetheme{Bergen}
%\usetheme{Berlin} % Overlap on text :S

%\usetheme{Marburg} % right side
%\usetheme{Montpellier} % hierarchy 3 lines on top
...
%\usecolortheme{dove} % real sober/ minimalist  
\usecolortheme{seahorse} % light, fine
%\usecolortheme{crane} % yellow (good)
%\usecolortheme{beaver} % little touch of red
%\usecolortheme{seagull} % whie and gray
%\usecolortheme{beetle} % gray

%\usecolortheme{dolphin}

%\usecolortheme{fly} % other gray
%\usecolortheme{lily}
%\usecolortheme{monarca} % yellow all the way


%\usecolortheme{spruce} % green ( alert is also green :S)
%\usecolortheme{whale}
